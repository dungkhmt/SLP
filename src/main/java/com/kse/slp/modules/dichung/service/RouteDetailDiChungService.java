...
public interface RouteDetailDiChungService {
	public int saveARouteDetailDiChung(String rDDC_RouteCode,String rDDC_TicketCode,int rDDC_Sequence,int rDDC_Group,String rDDC_Address,String rDDC_DistanceToNext,String rDDC_TravelTimeToNext);
