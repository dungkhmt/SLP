...
public interface RequestDiChungService {
	public int saveARequest(String rEQDC_TicketCode,String rEQDC_DepartTime,String rEQDC_ChunkName,String rEQDC_PickupAddress,String rEQDC_DeliveryAddress,String rEQDC_PickupPos,String rEQDC_DeliveryPos,int 	rEQDC_NumberPassengers, String rEQDC_BatchCode);
