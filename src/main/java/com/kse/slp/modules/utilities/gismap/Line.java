...
public class Line {
	...
	public TWO_SEGMENTS_RELATION intersectSegment(Line l, Point p){
	...
	public static void main(String[] args) {
		...
		Line l2 = new Line(6,2,8,9);
		Point p= new Point(1,1);
		TWO_SEGMENTS_RELATION r = l1.intersectSegment(l1, p);
		if(r == TWO_SEGMENTS_RELATION.SEGMENT_INTERSECTIONAL){
			System.out.println("p = " + p.toString());
		}else{
			System.out.println("two segment not intersets");
		}
	}
