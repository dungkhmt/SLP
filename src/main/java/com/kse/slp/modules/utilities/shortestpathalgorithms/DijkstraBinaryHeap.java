package com.kse.slp.modules.utilities.shortestpathalgorithms;
...
public class DijkstraBinaryHeap {
	...
	*/
	...
	public static void main(String[] args) {
		...
		/*
		 * Example directed graph: V = {1,3,5,7,9}, Arcs = {(1,3),(1,5),(1,9),(3,9),(3,1),(5,9),(9,7)}
		 */
		...
		DijkstraBinaryHeap d = new DijkstraBinaryHeap(V, A);
		Itinerary I = d.solve(1, 9);
